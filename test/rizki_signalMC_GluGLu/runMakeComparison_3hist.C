...
// 	option.push_back("425_SV1EnergyRatioreweight");
// 	option.push_back("425_SV1EnergyRatioreweight_jetNTracksreweight");
// 	option.push_back("425_IPSig1stAboveBreweight");
// 	option.push_back("425_Zratioreweight");
// 	option.push_back("425_SV1EnergyRatioreweight_Zratioreweight");
// 	option.push_back("425_SV1EnergyRatioreweight_SingleMu");
	option.push_back("425_Zratioreweight_SingleMu");
	option.push_back("425_SV1EnergyRatioreweight_Zratioreweight_SingleMu");
	...
	for (int i=0 ; i<option.size();i++){
		...
		for (int j=0 ; j<isLog.size();j++){
			...
			makeComparisonBackground_3hist("z_ratio_bfromg", 0, 30., "z_{ratio}",2,option[i], isLog[j]);
			makeComparisonBackground_3hist("jetNTracks_bfromg", 0, 40, "Number of tracks",1,option[i], isLog[j]);
			makeComparisonBackground_3hist("trackSip2dSigAboveBottom_0_bfromg", -20, 20, "IP Sig 1st Track Above Bottom",1,option[i], isLog[j]);
