...
fout = ROOT.TFile("SV1EnergyRatio_Hbb_QCDbb_pt"+pt+"_"+tag+"_weight.root", "RECREATE")
fout.cd()
...
c0.SaveAs("SV1EnergyRatio_Hbb_QCDbb_pt"+pt+"_"+tag+"_noweight.pdf")
...
c1.SaveAs("SV1EnergyRatio_Hbb_QCDbb_pt"+pt+"_"+tag+"_reweight.pdf")
...
c1.SaveAs("SV1EnergyRatio_Hbb_QCDbb_pt"+pt+"_"+tag+"_weights.pdf")
c1.SaveAs("SV1EnergyRatio_Hbb_QCDbb_pt"+pt+"_"+tag+"_weights.C")
