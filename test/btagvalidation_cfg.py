...
process.btagval = cms.EDAnalyzer('BTagValidation',
    ...
    File_PUDistMC          = cms.string('/afs/cern.ch/work/d/devdatta/CMSREL/BTagging/CMSSW_10_6_8_patch1/src/RecoBTag/BTagValidation/test/PUDist/PUDistMC_2017_25ns_WinterMC_PUScenarioV1_PoissonOOTPU.root'),
    Hist_PUDistMC          = cms.string('pileup'),
    File_PUDistData        = cms.string('/afs/cern.ch/work/d/devdatta/CMSREL/BTagging/CMSSW_10_6_8_patch1/src/RecoBTag/BTagValidation/test/PUDist/RunII2017BCDEF_17NovRereco_25ns_PUXsec69000nb.root'),
