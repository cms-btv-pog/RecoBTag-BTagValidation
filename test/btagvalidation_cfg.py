...
process.btagval = cms.EDAnalyzer('BTagValidation',
    ...
    File_PUDistMC          = cms.string('/afs/cern.ch/user/d/devdatta/afswork/CMSREL/BTagging/CMSSW_10_2_7/src/RecoBTag/BTagValidation/test/PUDist/PUDistMC_2018_25ns_JuneProjectionFull18_PoissonOOTPU.root'),
    Hist_PUDistMC          = cms.string('pileup'),
    File_PUDistData        = cms.string('/afs/cern.ch/user/d/devdatta/afswork/CMSREL/BTagging/CMSSW_10_2_7/src/RecoBTag/BTagValidation/test/PUDist/RunII2018_25ns_PUXsec69200nb.root'),
