...
process.btagval = cms.EDAnalyzer('BTagValidation',
    ...
    File_PUDistMC          = cms.string('/afs/cern.ch/user/d/devdatta/afswork/CMSREL/BTagging/CMSSW_10_6_12/src/RecoBTag/BTagValidation/test/PUDist/PUDistMC_2018_25ns_JuneProjectionFull18_PoissonOOTPU.root'),
    Hist_PUDistMC          = cms.string('pileup'),
    File_PUDistData        = cms.string('/afs/cern.ch/work/d/devdatta/CMSREL/BTagging/CMSSW_10_6_12/src/RecoBTag/BTagValidation/test/PUDist/RunII2018All_PUXsec69200nb.root'),
